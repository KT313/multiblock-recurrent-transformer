...
# Simple script to run script-mode generation as a SLURM batch job
# Uses ultimate partition with full GPU

echo "Submitting script-mode generation job..."

# Submit the job using heredoc
JOB_OUTPUT=$(sbatch <<'EOF'
#!/bin/bash
#SBATCH --job-name=gen-script
...
#SBATCH --output=/path/to/fast_storage/recpre/cluster/logs/script_mode_out_%j.txt
#SBATCH --error=/path/to/fast_storage/recpre/cluster/logs/script_mode_err_%j.txt

set -euo pipefail
set -x

echo "Starting script-mode generation job"
...
echo "=========================================="
echo "Script Mode Generation Configuration:"
echo "  Model: /path/to/shared_storage/recpre/outputs/hf_models/final-model-step-00151060-standalone"
echo "  Script: test_interactive_generation.py --script-mode"
echo "  Prompts: 4"
echo "  Step configs: 8"
echo "  Total outputs: 32"
echo "  Device: cuda"
echo "=========================================="
echo
...
# Run the script-mode generation
echo "Running script-mode generation..."
python3 test_interactive_generation.py --script-mode

echo "=========================================="
echo "Script-mode generation completed successfully!"
echo "=========================================="
EOF
)
...
LOG_FILE="/path/to/fast_storage/recpre/cluster/logs/script_mode_out_${JOB_ID}.txt"
ERR_FILE="/path/to/fast_storage/recpre/cluster/logs/script_mode_err_${JOB_ID}.txt"
