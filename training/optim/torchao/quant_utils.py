...
#
# Vendored from torchao/optim/quant_utils.py (pytorch/ao 6792133): the 8-bit functions only, the 4-bit and
# stochastic-rounding helpers (and their DTensor import) are left out.
import torch
