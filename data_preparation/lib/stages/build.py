...
def build_source(
    ...
    *,
    ...
    if processing.dedup.mode != "none":
        # rows_needed for the false-positive estimate: until the planner hands the build a row target (task 8), the
        # raw row count is the honest upper bound of what this build can insert
