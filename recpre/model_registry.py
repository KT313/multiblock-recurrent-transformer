...
# Changes (c) 2025-2026 Tobias Kerner: crow model family registry entries. See README and git history.
# type: ignore
...
# ### nebel-raven-tiny-test
# 
# Total parameters: 50,881,024
# Model initialized with 16m parameters in recurrent block.
# Will unfold to 235m mean parameters at test time (12 rec).
# Could unfold to 437m parameters at test time (24 rec).

# ### nebel-raven-small-test
# 
# Total parameters: 169,919,488
# Model initialized with 67m parameters in recurrent block.
# Will unfold to 908m mean parameters at test time (12 rec).
# Could unfold to 1,713m parameters at test time (24 rec).

# ### nebel-raven-large-test
# 
# Total parameters: 612,468,736
# Model initialized with 268m parameters in recurrent block.
# Will unfold to 6,787m mean parameters at test time (24 rec).
# Could unfold to 13,231m parameters at test time (48 rec).

rec = [
    dict(
        name="crow-300m-final",
        hf_config=dict(org="local", name="crow-300m-final"),
        block_size=2048,
        vocab_size=32000,
    ...
    dict(
        name="crow-300m-final-highrec",
        hf_config=dict(org="local", name="crow-300m-final-highrec"),
        block_size=2048,
        vocab_size=32000,
        padding_multiple=2048,
        tie_embeddings=True,
    ...
    dict(
        name="crow-300m-final-lite",
        hf_config=dict(org="local", name="crow-300m-final-lite"),
        block_size=2048,
        vocab_size=32000,
        padding_multiple=2048,
        tie_embeddings=True,
    ...
    dict(
        name="crow-300m-final-add",
        hf_config=dict(org="local", name="crow-300m-final-add"),
        block_size=2048,
        vocab_size=32000,
        padding_multiple=2048,
        tie_embeddings=True,
    ...
    dict(
        name="nebel-raven-small-test-norecsbaseline",
        hf_config=dict(org="local", name="nebel-raven-small-test-norecsbaseline"),
        block_size=2048,
        vocab_size=32000,
        padding_multiple=2048,
        tie_embeddings=True,
        ...
        init_strategy="takase",
        init_orthogonal=True,
        state_init="normal-small",
        # spell out the recurrent settings
        injection_type="none",
        n_layers_in_recurrent_block=[12],
        mean_recurrence=1,
        sampling_scheme="poisson-lognormal-filling",
    ...
    dict(
        name="nebel-raven-small-test-3recs-add",
        hf_config=dict(org="local", name="nebel-raven-small-test-3recs-add"),
        block_size=2048,
        vocab_size=32000,
        padding_multiple=2048,
        tie_embeddings=True,
    ...
    dict(
        name="nebel-raven-small-test-3recs-add-frozenembeddings",
        hf_config=dict(org="local", name="nebel-raven-small-test-3recs-add-frozenembeddings"),
        block_size=2048,
        vocab_size=151_936,
        padding_multiple=2048,
        pretrained_embeddings_from = "Qwen/Qwen3-0.6B",
        tie_embeddings=True,
        eos_token_id=151645,
        pad_token_id=151643,
        num_attention_heads=16,
    ...
    dict(
        name="nebel-raven-small-test-3recs-detach-noise",
        hf_config=dict(org="local", name="nebel-raven-small-test-3recs-detach-noise"),
        block_size=2048,
        vocab_size=32000,
        padding_multiple=2048,
        tie_embeddings=True,
        ...
        init_strategy="takase",
        init_orthogonal=True,
        state_init="none-detach",
        # spell out the recurrent settings
        injection_type="linear",
        intermediate_noise_injection=0.1,
    ...
    dict(
        name="nebel-raven-small-test-3recs-detach",
        hf_config=dict(org="local", name="nebel-raven-small-test-3recs-detach"),
        block_size=2048,
        vocab_size=32000,
        padding_multiple=2048,
        tie_embeddings=True,
    ...
    dict(
        name="nebel-raven-small-test-3recs",
        hf_config=dict(org="local", name="nebel-raven-small-test-3recs"),
        block_size=2048,
        vocab_size=32000,
        padding_multiple=2048,
        tie_embeddings=True,
    ...
    dict(
        name="nebel-raven-small-test-2recs",
        hf_config=dict(org="local", name="nebel-raven-small-test-2recs"),
        block_size=2048,
        vocab_size=32000,
        padding_multiple=2048,
        tie_embeddings=True,
        ...
        # spell out the recurrent settings
        injection_type="linear",
        n_layers_in_recurrent_block=[6, 6],
        mean_recurrence=12,
        sampling_scheme="poisson-lognormal-filling",
        mean_backprop_depth=8,
        n_layers_in_prelude=2,
    ...
    dict(
        name="nebel-raven-small-test-2recs-add",
        hf_config=dict(org="local", name="nebel-raven-small-test-2recs-add"),
        block_size=2048,
        vocab_size=32000,
        padding_multiple=2048,
        tie_embeddings=True,
    ...
    dict(
        name="nebel-raven-small-test-1recs",
        hf_config=dict(org="local", name="nebel-raven-small-test-1recs"),
        block_size=2048,
        vocab_size=32000,
        padding_multiple=2048,
        tie_embeddings=True,
    ...
    dict(
        name="nebel-raven-small-test-1recs-add",
        hf_config=dict(org="local", name="nebel-raven-small-test-1recs-add"),
        block_size=2048,
        vocab_size=32000,
        padding_multiple=2048,
        tie_embeddings=True,
    ...
    dict(
        name="nebel-raven-small-test-1recs-1loop",
        hf_config=dict(org="local", name="nebel-raven-small-test-1recs-1loop"),
        block_size=2048,
        vocab_size=32000,
        padding_multiple=2048,
        tie_embeddings=True,
    ...
    dict(
        name="nebel-raven-small-test-0recs",
        hf_config=dict(org="local", name="nebel-raven-small-test-0recs"),
        block_size=2048,
        vocab_size=32000,
        padding_multiple=2048,
        tie_embeddings=True,
        ...
        mean_backprop_depth=[],
        n_layers_in_prelude=2,
        n_layers_in_coda=2+12,
        qk_bias=True,
        activation_checkpoint_impl="per-iteration",  # SAC broken
    ),
    dict(
        name="nebel-raven-tiny-test",
        hf_config=dict(org="local", name="nebel-raven-tiny-test"),
        block_size=1024,
        vocab_size=32000,
    ...
    dict(
        name="nebel-raven-small-test",
        hf_config=dict(org="local", name="nebel-raven-small-test"),
        block_size=2048,
        vocab_size=32000,
        padding_multiple=2048,
        tie_embeddings=True,
    ...
    dict(
        name="nebel-raven-large-test",
        hf_config=dict(org="local", name="nebel-raven-large-test"),
        block_size=2048,
        vocab_size=32000,
        padding_multiple=2048,
        tie_embeddings=True,
